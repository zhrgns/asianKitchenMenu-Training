...
const btnFunc = () => {
    ...
    <button id="chinese" class="btn btn-outline-dark btn-item" type="button">Chinese</button>
    <button id="japan" class="btn btn-outline-dark btn-item" type="button">Japan</button>
    <button id="korean" class="btn btn-outline-dark btn-item" type="button">Korean</button>
    `
...
const listKoreanFoods = () => {
    ...
    menu.map(item => {
        if (item.category === "Korean") {
            koreanFoods += createFoods(item);
        }
    })
    menuSection.innerHTML = koreanFoods;
}

document.querySelector("#korean").addEventListener( "click", listKoreanFoods);
...
const listChineseFoods = () => {
    ...
    menu.map(item => {
        if (item.category === "Chinese") {
            chineseFoods += createFoods(item);
        }
    })
    menuSection.innerHTML = chineseFoods;
}

document.querySelector("#chinese").addEventListener( "click", listChineseFoods);
